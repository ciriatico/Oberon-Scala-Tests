...
class InterpreterTest extends AnyFunSuite {
  ...
  test(testName = "Testing bee1038: Sample Test 1"){
    val module = ScalaParser.parseResource("stmts/bee1038_Snack.oberon")

    assert(module.name == "bee1038")
  ...
  test(testName = "Testing bee1161: Sample Test 1"){
    val module = ScalaParser.parseResource("stmts/bee1161_NastyHacks.oberon")

    assert(module.name == "bee1161")
